...
\textbf{Result I.} The choice of C4GAP is motivated by: (i) there only $4!=24$ permutations, and (ii) ensure continuity with \citep{arora2019exact,npk}.  \Cref{tb:expresults} demonstrate the fact that computations in the weight/value network is \emph{disentangled in the path space}, i.e., destroying the layer-by-layer or providing a constant $\mathbf{1}$ input does not destroy the performance.
