...
\textbf{Result I.} C4GAP chosen as a toy network to experimentally demonstrate the fact that computations in the weight/value network is \emph{disentangled in the path space}, i.e., destroying the layer-by-layer or providing a constant $\mathbf{1}$ input does not destroy the performance as shown in \Cref{tb:expresults}
