...
We consider $3$ DNN architectures, the C4GAP in \Cref{fig:dgn}, VGG-16 and ResNet-110. The main purpose of using C4GAP is to experimentally demonstrate the fact that computations in the weight/value network is \emph{disentangled in the path space}. VGG-16 and ResNet-110 are chosen for their state of the art performance on standard datasets namely CIFAR-10 and CIFAR-100. We first present the results on experiments with C4GAP, followed by VGG-16 and ResNet-110. 
