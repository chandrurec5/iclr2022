...
\multirow{3}{*}{CIFAR10}		& C4GAP 		& 80.5\tiny{$\pm$0.4} 	& DGN$(x,x)$ 	& DGN$(x,\mathbf{1})$ 	&  DLGN$(x,x)$ 	& DLGN$(x,\mathbf{1})$ & DSLGN$(x,x)$ 	& DSLGN$(x,\mathbf{1})$\\
						& VGG16-AP 	& 93.6\tiny{$\pm$0.2} 	& 93.0\tiny{$\pm$0.1}  	& 93.0\tiny{$\pm$0.1}   		&  87.0\tiny{$\pm$0.1}	& 87.0\tiny{$\pm$0.2}	&  85.0\tiny{$\pm$0.3} 	& 85.1\tiny{$\pm$0.2} \\
...
\multirow{2}{*}{CIFAR100}		& VGG16-AP 	& 73.4\tiny{$\pm$0.3}  	& 70.3\tiny{$\pm$0.1} 	&  70.5\tiny{$\pm$0.2} 	&  61.5\tiny{$\pm$0.2}	& 61.5\tiny{$\pm$0.1}&  55.5\tiny{$\pm$0.4} 	& 55.5\tiny{$\pm$0.3}\\
