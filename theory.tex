...
{\centering{$\textbf{overlap}_{\Theta}(i,x,x') = \Lambda_{\Theta}(i,x,x') \eqdef \frac{\left|\{p \colon  p\,\, \text{starts at input node }\,\, i\,\, \text{and}\,\,A_{\Theta}(x,p)= A_{\Theta}(x',p)=1\} \right|}{\din}$}\par}
\end{definition}
