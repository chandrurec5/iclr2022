...
\textbf{Our Contribution.}  In this paper, we \emph{extend the dual view} to address `black box'-ness by completely \emph{disentangling} the `learning in the gates' in the `gating network' and `learning in the weights' in the weights network. Our contributions are listed below.
