...
\node [] (dgn-f-input) at (1.75,0){$x^{\text{f}}$};
\draw [-stealth,thick]   (dgn-f-input.north) -- (dgn-f-c1.south);




\node []  (dgn-output) at (7.75,-0.5) {$\hat{y}(x)$};
\node [] (dgn-smax) at (7.75,-1.5){\tiny{FC}};
\draw [-stealth,thick]   (dgn-smax.north)--(dgn-output.south);

\node [rotate=-90] (dgn-gap) at (7.75,-2.5){\tiny{GAP}};
\draw [-stealth,thick]   (dgn-gap.west)--(dgn-smax.south);
...
\node [] (dgn-input) at (1.75,-1){$x^{\text{v}}$};
\draw [-stealth,thick]   (dgn-input.south) -- (dgn-v-c1.north);
